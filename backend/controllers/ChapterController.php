...
use backend\models\search\ChapterSearch;
...
class ChapterController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            ...
            $model->pdfFile->saveAs('uploads/bookChapters/'.$pdfName.'.'.$model->pdfFile->extension);
            $model->pdf_url = 'uploads/bookChapters/'.$pdfName.'.'.$model->pdfFile->extension;
            $model->save();
